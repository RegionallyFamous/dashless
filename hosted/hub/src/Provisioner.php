            ...
            try {
                ...
                if (empty($a['site_id'])) {
                    ...
                    if ($found) {
                        ...
                        $a['site_id']=$found['site_id'];$a['step']='bootstrap';$this->identity->save($a);
                        ...
                        $a['site_id']=(int)$created['atomic_site_id'];$a['cloud_job_id']=$created['job_id']??null;$a['step']='bootstrap';$this->identity->save($a);
                        return $a;
                    }
                }
                if ($a['step']==='bootstrap') {
                    ...
                    $a['step']='initial_build';$this->identity->save($a);
                }
                if ($a['step']==='initial_build') {
                    ...
                    $a['release_id']=$job['release_id'];$a['step']='verify';$this->identity->save($a);
                }
                if ($a['step']==='verify') {
