...
final class Admin {
    ...
    public function page(): void {
        ...
        foreach(['pages'=>'Install missing account pages','reconcile'=>'Queue reconciliation','purge_expired'=>'Run cleanup'] as $op=>$label){$this->formStart($op);submit_button($label,'secondary');echo '</form>';}
