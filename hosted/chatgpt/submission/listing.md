...
**Suggested category:** Productivity / Writing (select the portal's closest available category).

**Universal MCP server:** `https://dashless.blog/mcp`

**Website:** https://dashless.blog/

**Support:** https://dashless.blog/support/

**Privacy:** https://dashless.blog/privacy/
...
- “Prepare an export of my blog and source.”

**Initial release notes:** Existing-account integration with OAuth, draft and curated design tools, authenticated image transfer, background job status and private browser preview/approval. Publication and rollback require cookie-and-nonce authenticated review; the inline card does not mint approval. Status distinguishes saved, preview-ready, WordPress-published, deployed and publicly verified.
